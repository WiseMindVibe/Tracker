...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('conversions_events', function (Blueprint $table) {
            ...
            $table->unique(['affiliate_catalog_id', 'event_id', 'click_id', 'commission_id'], 'conversion_events_dedupe_unique');
        });
        ...
        Schema::create('conversions', function (Blueprint $table) {
            ...
            $table->decimal('commission', 10, 5)->nullable();
            $table->string('status')->nullable();
            $table->decimal('accumulated_commission', 10, 5)->default(0);
            $table->decimal('loss', 10, 5)->default(0);
            ...
            $table->index(['conversion_event_id', 'status'], 'conversions_reporting_event_status_index');
